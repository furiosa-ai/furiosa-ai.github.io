...
:meth:`get_default_sampling_params` are used. The same behavior applies to
:meth:`furiosa_llm.LLM.chat` and :meth:`furiosa_llm.LLM.stream_generate`.
See :ref:`DefaultSamplingParams` for details.
...
Returns the :class:`furiosa_llm.SamplingParams` used when ``generate()``,
...
is returned. See :ref:`DefaultSamplingParams` for the full list of
