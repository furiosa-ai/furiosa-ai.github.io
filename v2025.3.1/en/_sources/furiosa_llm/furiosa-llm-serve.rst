...
.. literalinclude:: ../../../examples/openai_server_curl.sh
  :language: sh
...
.. literalinclude:: ../../../examples/openai_server_async_client.py
  :language: python
...
.. literalinclude:: ../../../examples/openai_server_launch_toolcalling.sh
  :language: python

To use the tool calling feature, specify the ``tools`` and ``tool_choice``
parameters. Here's an example:

.. literalinclude:: ../../../examples/openai_server_client_toolcalling.py
  :language: python
...
.. literalinclude:: ../../../examples/openai_server_launch_reasoning.sh
  :language: bash
...
.. literalinclude:: ../../../examples/openai_server_client_reasoning.py
  :language: python
...
.. list-table::
   ...
   * - ``furiosa_llm_num_requests_running``
     - Gauge
     - ``model_name``
     - Number of requests running on RNGD.
   * - ``furiosa_llm_num_requests_waiting``
     - Gauge
     - ``model_name``
     - Number of requests waiting to be processed.
   * - ``furiosa_llm_request_received_total``
     - Counter
     - ``model_name``
   ...
   * - ``furiosa_llm_request_failure_total``
     - Counter
     - ``model_name``
   ...
   * - ``furiosa_llm_time_per_output_token_seconds``
     - Histogram
     - ``model_name``
   ...
   * - ``furiosa_llm_kv_cache_used_bytes``
     - Gauge
     - ``model_name``, ``device_index``
     - Size of used KV-cache in bytes.
   * - ``furiosa_llm_kv_cache_total_bytes``
     - Gauge
     - ``model_name``, ``device_index``
     - Total KV-cache size in bytes.
   * - ``furiosa_llm_kv_cache_usage_perc``
     - Gauge
     - ``model_name``, ``device_index``
     - KV-cache usage. 1 means 100 percent usage.
   * - ``furiosa_llm_pipeline_info``
     - Gauge
     - ``model_name``, ``pipeline_id``, ``device_id``, ``device_index``
