...
.. literalinclude:: ../../../examples/build-artifact-specifying-buckets.sh
  :language: bash
...
.. literalinclude:: ../../../examples/build-artifact-tp.sh
  :language: bash
...
.. literalinclude:: ../../../examples/build-artifact-tp+pp.sh
  :language: bash
...
.. literalinclude:: ../../../examples/build-artifact-trust-remote-code.sh
  :language: bash
...
.. literalinclude:: ../../../examples/build-artifact-chunked-prefill.sh
  :language: bash
...
.. literalinclude:: ../../../examples/build-artifact-with-workers.sh
  :language: bash
